...
const MenuItems = [
  ...
  {title: "Compras", icon: <AddShoppingCart />, items: [{title: "Cotação", link: "/buy/quotations"}, {title: "Pedidos", link: "/buy/orders"}]},
  ...
  {title: "Logistica", icon: <LocalShipping />, items: [{title: "Calculo de frete", link: "/logistic/freight-calculations"}, {title: "Cotação de frete", link: "/logistic/freight-quotes"}, {title: "Ordens de carga", link: "/logistic/shipping-orders"}, {title: "Viagens", link: "/logistic/trips"}, {title: "Andamento", link: "/logistic/progress"}]},
  {title: "Fiscal", icon: <TableView />, items: [{title: "Distribuição", link: "/fiscal/distributions"}, {title: "Notas fiscais", link: "/fiscal/nfes"}, {title: "Conhecimentos", link: "/fiscal/ctes"}, {title: "Manifestos", link: "/fiscal/manifestos"}, {title: "SPED", link: "/fiscal/sped"}]},
]

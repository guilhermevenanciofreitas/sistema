...
const MenuItems = [
  ...
  {title: "Fiscal", icon: <TableView />, items: [{title: "Distribuição", link: "/fiscal/distributions"}, {title: "Notas fiscais", link: "/fiscal/nfes"}, {title: "Conhecimentos", link: "/fiscal/ctes"}, {title: "Manifestos", link: "/fiscal/manifestos"}]},
]

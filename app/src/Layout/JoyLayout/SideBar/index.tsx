...
const MenuItems = [
  ...
  {title: "Logistica", icon: <LocalShipping />, items: [{title: "Calculo de frete", link: "/logistic/freight-calculation"}, {title: "Cotação de frete", link: "/logistic/freight-quote"}, {title: "Ordens de carga", link: "/logistic/shippings-orders"}, {title: "Andamento", link: "/logistic/progress"}, {title: "Viagens", link: "/logistic/trips"}]},

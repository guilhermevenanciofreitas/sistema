...
export default class TripsBase extends BaseIndex {
 
    protected ViewTrip = React.createRef<ViewTrip>();
    ...
    protected BtnNovo_Click = async (): Promise<void> =>
    {
        try
        {
            ...
            const r = await this.ViewTrip.current?.Show(undefined);
    ...
    private OpenShippingOrder = async (id: string, isHitoryBack: boolean = true) =>
    {
        ...
        const r = await this.ViewTrip.current?.Show(id);
    ...
    protected Pesquisar = async(request: any): Promise<void> =>
    {
        ...
        var r = await Service.Post('logistic/trip/findAll', request);

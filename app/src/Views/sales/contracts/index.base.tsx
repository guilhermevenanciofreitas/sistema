...
import { ViewContrato } from "./View/index";
...
export default class BaseContratos extends BaseIndex {
 
    protected ViewContrato = React.createRef<ViewContrato>();
    ...
    protected BtnNovo_Click = async (): Promise<void> =>
    {
        try
        {
            ...
            const r = await this.ViewContrato.current?.Show(undefined);
    ...
    private OpenContrato = async (id: string) =>
    {
        ...
        const r = await this.ViewContrato.current?.Show(id);
        history.back();
        return r;
    }
    ...
    protected Pesquisar = async(Data: any): Promise<void> =>
    {
        ...
        var r = await Service.Post("contrato/findAll", Data);

...
import { ViewConhecimentoBase } from './index.base';
...
export class ViewConhecimento extends ViewConhecimentoBase {
            ...
            <ViewModal ref={this.ViewModal} Title={this.props.Title} Width={900}>
                ...
                <Content>
                    <Grid container spacing={1} sx={{ flexGrow: 1 }}>
                        ...
                        <Grid md={7}>
                            <TextBox Label='Chave de acesso' Mask={'#### #### #### #### #### #### #### #### #### #### ####'} TextTransform='Normal' Text={_.get(this.state, 'protCTe.infProt.chCTe')} OnChange={(args: EventArgs) => this.setState((state) => _.set(state, 'protCTe.infProt.chCTe', args.Value))} EndDecorator={<IconButton onClick={this.BtnConsultar} ><TravelExplore /></IconButton>} />
                        </Grid>
                        <Grid md={5}>

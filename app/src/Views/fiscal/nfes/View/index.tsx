...
import { Button, CheckBox, Form, ViewModal, Tab, TabItem, TextBox, DropDownList, DropDownListItem, AutoComplete, DatePicker, GridView, Content, Actions } from '../../../../Utils/Controls';
...
import { CheckCircleOutlined, Print } from '@mui/icons-material';
    ...
    public render(): ReactNode {
        ...
        return (
            <ViewModal ref={this.ViewModal} Title={this.props.Title} Width={1150}>
                ...
                <Actions>
                    <Button Text='Imprimir' StartIcon={<Print />} Color={'white'} BackgroundColor={color.primary} OnClick={() => null} />

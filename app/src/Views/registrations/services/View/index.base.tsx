...
export class ViewServicoBase extends React.Component<Readonly<{Title: string}>> {
    ...
    public Show = async (id?: string): Promise<any> =>
    {
        ...
        if (id) {
            Loading.Show();
            const r = await Service.Post("registrations/service/findOne", {id});
            Loading.Hide();
    ...
    protected BtnSalvar_Click = async () =>
    {
        try
        {
            ...
            let r = await Service.Post("registrations/service/save", this.state);

...
export default class BaseServicos extends BaseIndex {
 
    protected ViewServico = React.createRef<ViewServico>();
    ...
    protected BtnNovo_Click = async (): Promise<void> =>
    {
        try
        {
            ...
            const r = await this.ViewServico.current?.Show(undefined);
    ...
    private OpenProduto = async (id: string) =>
    {
        ...
        const r = await this.ViewServico.current?.Show(id);
        history.back();
        return r;
    }
    ...
    protected Pesquisar = async(Data: any): Promise<void> =>
    {
        ...
        var r = await Service.Post("registrations/service/findAll", Data);

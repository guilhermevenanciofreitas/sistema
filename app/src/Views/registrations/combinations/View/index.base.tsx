...
export class ViewCombinationBase extends React.Component<Readonly<{Title: string}>> {
    ...
    public New = async (combination: any) =>
    {
    ...
    public Edit = async (id?: string): Promise<any> =>
    {
        ...
        if (id) {
            Loading.Show();
            const r = await Service.Post("registrations/combination/findOne", {id});
            Loading.Hide();
    ...
    protected BtnSalvar_Click = async () =>
    {
        try
        {
            ...
            Loading.Show();
            let r = await Service.Post("registrations/combination/save", request);
            Loading.Hide();

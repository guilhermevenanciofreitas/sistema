...
export class ViewProductSubCategoryBase extends React.Component<Readonly<{Title: string}>> {
    ...
    public Edit = async (id?: string): Promise<any> =>
    {
        ...
        if (id) {
            Loading.Show();
            const r = await Service.Post("registrations/product-subcategory/findOne", {id});
            Loading.Hide();
    ...
    protected BtnSalvar_Click = async () =>
    {
        try
        {
            ...
            Loading.Show();
            let r = await Service.Post("registrations/product-subcategory/save", request);
            Loading.Hide();

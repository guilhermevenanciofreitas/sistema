    ...
    protected BtnSalvar_Click = async () =>
    {
        try
        {
            ...
            if (this.state.supplier == null) {
                await MessageBox.Show({title: "Info", width: 400, type: "Warning", content: "Informe o fornecedor para compra!", buttons: [{ Text: "OK" }]});
                return;
            }
            ...
            const request = {
                ...
                buyerId: _.get(this.state.buyer, 'id') || null,

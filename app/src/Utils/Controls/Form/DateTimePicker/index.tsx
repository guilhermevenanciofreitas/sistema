...
export class ControlDateTimePicker extends DateTimePickerBase {
    ...
    render(): React.ReactNode
    {
        return (
            <>
                ...
                <Input size='sm' type='datetime-local' placeholder={this.props.PlaceHolder} value={this.props.Text || ""} onChange={this.TextBox_Change} disabled={this.props.ReadOnly} />
            </>
        );
    }

...
import { DialogTitle, Divider, IconButton, Modal, ModalDialog } from "@mui/joy";
    ...
    render(): React.ReactNode {
        return (
            <Modal open={this.props.Open} onClose={() => this.props.Close()} style={{zIndex: 10000}}>
                <ModalDialog minWidth={this.props.Width} maxWidth={this.props.Width} {...{sx: {top: '100px', left: '50%', transform: 'translateX(-50%)'}}}>

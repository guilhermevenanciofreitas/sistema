...
ALTER TABLE "city" ADD COLUMN IF NOT EXISTS "description" VARCHAR(60);
ALTER TABLE "city" ADD COLUMN IF NOT EXISTS "acronym" VARCHAR(2);
ALTER TABLE "city" ADD COLUMN IF NOT EXISTS "ibge" INT;
ALTER TABLE "city" ADD COLUMN IF NOT EXISTS "pais" INT;
ALTER TABLE "city" ADD COLUMN IF NOT EXISTS "ddd" JSON;
...
ALTER TABLE "stockIn" ADD COLUMN IF NOT EXISTS "stockId" UUID;
...
ALTER TABLE "stockInProduct" ADD COLUMN IF NOT EXISTS "product" UUID;
...
ALTER TABLE "stockInProduct" ADD COLUMN IF NOT EXISTS "status" VARCHAR(20);
...
ALTER TABLE "product" ADD COLUMN IF NOT EXISTS "stock" DECIMAL(18, 2);
